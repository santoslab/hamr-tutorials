...
pub fn testInitializeCB() -> HarnessResult
{
  ...
  let api_temp_changed = get_temp_changed();
  let api_current_temp = get_current_temp();

  // [CheckPost]: invoke the oracle function
  if !GUMBOX::initialize_IEP_Post (api_temp_changed, api_current_temp) {
...
pub fn testComputeCB() -> HarnessResult
{
  ...
  // [CheckPost]: invoke the oracle function
  if !GUMBOX::compute_CEP_Post(api_temp_changed, api_current_temp) {
