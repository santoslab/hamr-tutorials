...
//     sireum proyek run . ProdConsExample.Demo
//
//   To see the available CLI options:
//     sireum proyek run . ProdConsExample.Demo -h
//
//   To run the example unit tests from the command line:
//     sireum proyek test .
//
//   To build an executable jar:
//     sireum proyek assemble --uber --main ProdConsExample.Demo .
//
// Sireum IVE:
//
...
//     Right click src/main/architecture/ProdConsExample/Demo.scala and choose "Run 'Demo'"
//
