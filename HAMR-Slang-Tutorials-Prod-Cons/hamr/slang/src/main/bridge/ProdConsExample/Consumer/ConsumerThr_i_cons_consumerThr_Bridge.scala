...
object ConsumerThr_i_cons_consumerThr_Bridge {
  ...
  @datatype class EntryPoints(
    ...
    def activate(): Unit = {
      // implement the following method in 'component':  def activate(api: ConsumerThr_i_Operational_Api): Unit = {}
      component.activate(operational_api)
    }

    def deactivate(): Unit = {
      // implement the following method in 'component':  def deactivate(api: ConsumerThr_i_Operational_Api): Unit = {}
    ...
    def recover(): Unit = {
      // implement the following method in 'component':  def recover(api: ConsumerThr_i_Operational_Api): Unit = {}
