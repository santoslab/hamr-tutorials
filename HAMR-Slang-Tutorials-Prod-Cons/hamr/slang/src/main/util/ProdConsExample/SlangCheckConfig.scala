...
@datatype class Config_ProdConsMessage_i(attempts: Z, verbose: B, filter: ProdCons.Message_i => B) {}

@datatype class Config_ProdConsMessage_i_Payload(attempts: Z, verbose: B, filter: ProdCons.Message_i_Payload => B) {}
