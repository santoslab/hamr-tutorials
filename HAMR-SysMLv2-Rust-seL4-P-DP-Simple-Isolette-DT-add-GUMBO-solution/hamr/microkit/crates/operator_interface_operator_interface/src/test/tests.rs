...
mod GUMBOX_manual_tests {
  ...
  //---------------------------------------------------
  //  Simple (non-exhaustive) tests for REQ_OP_5, 
  //  illustrating an input value that satisfies the
  //  input integration constraint on display temp and 
  //  another that does not satisfy the integration constraint
  //  (evidenced by a failing pre-condition on the auto-generated
  //   GUMBOX test harness).
  //---------------------------------------------------
