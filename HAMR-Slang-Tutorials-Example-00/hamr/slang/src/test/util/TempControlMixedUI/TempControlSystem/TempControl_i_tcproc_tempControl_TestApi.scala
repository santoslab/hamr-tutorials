...
@msig trait TempControl_i_tcproc_tempControl_TestApi {
  ...
  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.TempControlSystem_i_Instance_tcproc_tempControl)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.TempControlSystem_i_Instance_tcproc_tempControl)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.TempControlSystem_i_Instance_tcproc_tempControl)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.TempControlSystem_i_Instance_tcproc_tempControl)
  }
  ...
  def put_concrete_inputs(currentTemp : TempSensor.Temperature_i,
                          ...
                          setPoint : ISZ[TempControlSystem.SetPoint_i],
                          tempChanged : Z): Unit = {
  ...
  def put_currentTemp(value : TempSensor.Temperature_i): Unit = {
    Art.insertInInfrastructurePort(Arch.TempControlSystem_i_Instance_tcproc_tempControl.operational_api.currentTemp_Id, TempSensor.Temperature_i_Payload(value))
  }

  // setter for in EventDataPort
  def put_fanAck(value : CoolingFan.FanAck.Type): Unit = {
    Art.insertInInfrastructurePort(Arch.TempControlSystem_i_Instance_tcproc_tempControl.operational_api.fanAck_Id, CoolingFan.FanAck_Payload(value))
  }

  // setter for in EventDataPort
  def put_setPoint(value : TempControlSystem.SetPoint_i): Unit = {
    Art.insertInInfrastructurePort(Arch.TempControlSystem_i_Instance_tcproc_tempControl.operational_api.setPoint_Id, TempControlSystem.SetPoint_i_Payload(value))
  }

  // setter for in EventPort
  def put_tempChanged(): Unit = {
    Art.insertInInfrastructurePort(Arch.TempControlSystem_i_Instance_tcproc_tempControl.operational_api.tempChanged_Id, art.Empty())
  }
  ...
  def get_fanCmd_payload(): Option[CoolingFan.FanCmd_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.TempControlSystem_i_Instance_tcproc_tempControl.initialization_api.fanCmd_Id).asInstanceOf[Option[CoolingFan.FanCmd_Payload]]
  }
