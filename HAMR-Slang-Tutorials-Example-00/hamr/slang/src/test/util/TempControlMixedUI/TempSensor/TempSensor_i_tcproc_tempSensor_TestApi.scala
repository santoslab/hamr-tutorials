...
@msig trait TempSensor_i_tcproc_tempSensor_TestApi {
  ...
  def BeforeEntrypoint(): Unit = {
    Art.initTest(Arch.TempControlSystem_i_Instance_tcproc_tempSensor)
  }

  def AfterEntrypoint(): Unit = {
    Art.finalizeTest(Arch.TempControlSystem_i_Instance_tcproc_tempSensor)
  }

  def testCompute(): Unit = {
    Art.manuallyClearOutput()
    Art.testCompute(Arch.TempControlSystem_i_Instance_tcproc_tempSensor)
  }

  def testInitialise(): Unit = {
    Art.manuallyClearOutput()
    Art.testInitialise(Arch.TempControlSystem_i_Instance_tcproc_tempSensor)
  }
  ...
  def get_currentTemp_payload(): Option[TempSensor.Temperature_i_Payload] = {
    return Art.observeOutInfrastructurePort(Arch.TempControlSystem_i_Instance_tcproc_tempSensor.initialization_api.currentTemp_Id).asInstanceOf[Option[TempSensor.Temperature_i_Payload]]
  }
  ...
  def get_tempChanged_payload(): Option[art.Empty] = {
    return Art.observeOutInfrastructurePort(Arch.TempControlSystem_i_Instance_tcproc_tempSensor.initialization_api.tempChanged_Id).asInstanceOf[Option[art.Empty]]
  }
