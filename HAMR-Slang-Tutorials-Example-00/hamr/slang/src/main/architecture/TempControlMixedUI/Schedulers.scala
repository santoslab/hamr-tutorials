...
object Schedulers {
  ...
  val threadNickNames: Map[String, Art.BridgeId] = Map(
    ISZ(
      Arch.TempControlSystem_i_Instance_tcproc_tempSensor.name ~> Arch.TempControlSystem_i_Instance_tcproc_tempSensor.id,
      Arch.TempControlSystem_i_Instance_tcproc_fan.name ~> Arch.TempControlSystem_i_Instance_tcproc_fan.id,
      Arch.TempControlSystem_i_Instance_tcproc_tempControl.name ~> Arch.TempControlSystem_i_Instance_tcproc_tempControl.id,
      Arch.TempControlSystem_i_Instance_tcproc_operatorInterface.name ~> Arch.TempControlSystem_i_Instance_tcproc_operatorInterface.id)
  )
  ...
  val TempControlSystem_i_Instance_tcproc_tempSensor_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = None(),
    domain = None())

  val TempControlSystem_i_Instance_tcproc_fan_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = None(),
    domain = None())

  val TempControlSystem_i_Instance_tcproc_tempControl_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = None(),
    domain = None())

  val TempControlSystem_i_Instance_tcproc_operatorInterface_timingProperties: ThreadTimingProperties = ThreadTimingProperties(
    computeExecutionTime = None(),
    domain = None())
  ...
  val defaultDomainToBridgeIdMap: ISZ[Art.BridgeId] = ISZ(
    /* domain 0 */ Arch.TempControlSystem_i_Instance_tcproc_tempSensor.id,
    /* domain 1 */ Arch.TempControlSystem_i_Instance_tcproc_fan.id,
    /* domain 2 */ Arch.TempControlSystem_i_Instance_tcproc_tempControl.id,
    /* domain 3 */ Arch.TempControlSystem_i_Instance_tcproc_operatorInterface.id
  )
