...
verus! {
  ...
  pub trait thermostat_thermostat_Get_Api: thermostat_thermostat_Api {
    ...
    fn unverified_get_current_temp(
      ...
      ensures
        ...
        (crate::component::thermostat_thermostat_app::DT_Lower_Bound() <= res.degrees) &&
          (res.degrees <= crate::component::thermostat_thermostat_app::DT_Upper_Bound()),
    {
  ...
  impl<API: thermostat_thermostat_Put_Api> thermostat_thermostat_Application_Api<API> {
    ...
    pub fn put_display_temp(
      ...
      requires
        // guarantee DT_Range
        (crate::component::thermostat_thermostat_app::DT_Lower_Bound() <= value.degrees) &&
          (value.degrees <= crate::component::thermostat_thermostat_app::DT_Upper_Bound()),
      ensures
        old(self).current_temp == self.current_temp,
        old(self).desired_temp == self.desired_temp,
