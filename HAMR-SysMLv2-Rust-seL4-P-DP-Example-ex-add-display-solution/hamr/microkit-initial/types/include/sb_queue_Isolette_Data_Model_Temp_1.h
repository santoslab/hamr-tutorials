...
// SB_QUEUE_ISOLETTE_DATA_MODEL_TEMP_1_SIZE-1 elements.
#define SB_QUEUE_ISOLETTE_DATA_MODEL_TEMP_1_SIZE 2
...
typedef struct sb_queue_Isolette_Data_Model_Temp_1 {
  ...
  // Queue of elements of type Isolette_Data_Model_Temp
  // (see sb_types.h) implemented as a ring buffer.
  // No initialization necessary.
  Isolette_Data_Model_Temp elt[SB_QUEUE_ISOLETTE_DATA_MODEL_TEMP_1_SIZE];

} sb_queue_Isolette_Data_Model_Temp_1_t;
...
typedef struct sb_queue_Isolette_Data_Model_Temp_1_Recv {
...
} sb_queue_Isolette_Data_Model_Temp_1_Recv_t;
...
// dropped since the last call to sb_queue_Isolette_Data_Model_Temp_1_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_Isolette_Data_Model_Temp_1_dequeue will fail to count a multiple of COUNTER_MAX in
