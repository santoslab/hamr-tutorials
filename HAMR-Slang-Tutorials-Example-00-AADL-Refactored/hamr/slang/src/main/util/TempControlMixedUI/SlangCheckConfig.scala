...
@datatype class Config_TempControlSystemSetPoint_i(attempts: Z, verbose: B, filter: TempControlSystem.SetPoint_i => B) {}

@datatype class Config_TempControlSystemSetPoint_i_Payload(attempts: Z, verbose: B, filter: TempControlSystem.SetPoint_i_Payload => B) {}

@datatype class Config_TempSensorTempUnitType(attempts: Z, verbose: B, filter: TempSensor.TempUnit.Type => B) {}

@datatype class Config_TempSensorTempUnit_Payload(attempts: Z, verbose: B, filter: TempSensor.TempUnit_Payload => B) {}
