...
//     sireum proyek run . TempControlMixedUI.Demo
//
//   To see the available CLI options:
//     sireum proyek run . TempControlMixedUI.Demo -h
//
//   To run the example unit tests from the command line:
//     sireum proyek test .
//
//   To build an executable jar:
//     sireum proyek assemble --uber --main TempControlMixedUI.Demo .
//
// Sireum IVE:
//
...
//     Right click src/main/architecture/TempControlMixedUI/Demo.scala and choose "Run 'Demo'"
//
