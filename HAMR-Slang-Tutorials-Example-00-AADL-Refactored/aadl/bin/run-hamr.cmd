...
// NOTE: the AADL model in this project has been refactored, however
//       the slang source is based on the pre-refactored version.  
//       Therefore use the pre-refactored AADL model
val aadlDir = Os.slashDir.up.up.up / "HAMR-Slang-Tutorials-Example-00" / "aadl"
...
val packageName = "TempControlMixedUI"

val slangOutputDir =  Os.slashDir.up.up / "hamr" / "slang"
