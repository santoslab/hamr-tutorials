...
// SB_QUEUE_SYSPROPSTRUCTSPLIT_DATA_MODEL_STRUCTXY_1_SIZE-1 elements.
#define SB_QUEUE_SYSPROPSTRUCTSPLIT_DATA_MODEL_STRUCTXY_1_SIZE 2
...
typedef struct sb_queue_SysPropStructSplit_Data_Model_StructXY_1 {
  ...
  // Queue of elements of type SysPropStructSplit_Data_Model_StructXY
  // (see sb_types.h) implemented as a ring buffer.
  // No initialization necessary.
  SysPropStructSplit_Data_Model_StructXY elt[SB_QUEUE_SYSPROPSTRUCTSPLIT_DATA_MODEL_STRUCTXY_1_SIZE];

} sb_queue_SysPropStructSplit_Data_Model_StructXY_1_t;
...
typedef struct sb_queue_SysPropStructSplit_Data_Model_StructXY_1_Recv {
...
} sb_queue_SysPropStructSplit_Data_Model_StructXY_1_Recv_t;
...
// dropped since the last call to sb_queue_SysPropStructSplit_Data_Model_StructXY_1_dequeue(). *data is left in
// unspecified state.
//
// If the sender ever gets ahead of a receiver by more than COUNTER_MAX,
// sb_queue_SysPropStructSplit_Data_Model_StructXY_1_dequeue will fail to count a multiple of COUNTER_MAX in
